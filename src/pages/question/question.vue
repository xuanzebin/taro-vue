    ...
    <view class="question-wrp">
      <view class="question-item">
        ...
        <view class="que-follow">
          <view class="left">
            <view class="watch">
              <image src="../../asset/images/eye.png" />
              <text>3316</text>
            </view>
            <view class="comment">
              <image src="../../asset/images/comment2.png" />
              <text>27</text>
            </view>
          </view>
          <view class="right">
      ...
      <view class="que-operate flex-wrp">
        <view class="invite flex-item">
          <image src="../../asset/images/invite.png" />
          <text>邀请回答</text>
        </view>
        <view class="write flex-item">
          <image src="../../asset/images/write.png" />
          <text>写回答</text>
        </view>
      </view>
    </view>
    <view class="answer-feed">
      <view class="feed-item">
        <view class="feed-source">
          <view>
            <view class="avatar">
              <image src="../../asset/images/icon1.jpeg" />
            </view>
            <text class="answer-name">
              Rebecca
            </text>
          </view>
        </view>
